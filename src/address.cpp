...
namespace Xten
{
                         ...
                         int family, int type, int protocol)
    {
        ...
        if (error)
        {
            XTEN_LOG_DEBUG(g_logger) << "Address::Lookup getaddress(" << host << ", "
                                        ...
                                        int family)
    {
        ...
        {
            XTEN_LOG_DEBUG(g_logger) << "Address::GetInterfaceAddresses getifaddrs "
                                        " err="
        ...
        {
            XTEN_LOG_ERROR(g_logger) << "Address::GetInterfaceAddresses exception";
            freeifaddrs(results);
            return false;
        }
        freeifaddrs(results);
    ...
    IPAddress::ptr IPAddress::Create(const char *address, uint16_t port)
    {
        ...
        if (error)
        {
            XTEN_LOG_DEBUG(g_logger) << "IPAddress::Create(" << address
                                     << ", " << port << ") error=" << error
    ...
    IPv4Address::ptr IPv4Address::Create(const char *address, uint16_t port)
    {
        ...
        if (result <= 0)
        {
            XTEN_LOG_DEBUG(g_logger) << "IPv4Address::Create(" << address << ", "
    ...
    IPv6Address::ptr IPv6Address::Create(const char *address, uint16_t port)
    {
        ...
        if (result <= 0)
        {
            XTEN_LOG_DEBUG(g_logger) << "IPv6Address::Create(" << address << ", "
                                     << port << ") rt=" << result << " errno=" << errno
                                     << " errstr=" << strerror(errno);
            return nullptr;
        }
