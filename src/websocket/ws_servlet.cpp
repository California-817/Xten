...
namespace Xten
{
    namespace http
    {
        ...
        int32_t FunctionWSServlet::onConnect(Xten::http::HttpRequest::ptr header, Xten::http::WSSession::ptr session)
        {
            if (m_onConnect)
            {
        ...
        int32_t FunctionWSServlet::onClose(Xten::http::HttpRequest::ptr header, Xten::http::WSSession::ptr session)
        {
            if (m_onClose)
            {
        ...
        int32_t FunctionWSServlet::handle(Xten::http::HttpRequest::ptr header, Xten::http::WSFrameMessage::ptr msg,
        ...
        void WSServletDispatch::addServlet(const std::string &uri, FunctionWSServlet::callback cb,
                                           FunctionWSServlet::on_connect_cb connect_cb, FunctionWSServlet::on_close_cb close_cb)
        {
